    ...
    <section id="home" class="hero">
        <div class="hero-container">
            <div class="hero-content">
                <div class="hero-text">
                    <h1 class="hero-title">
                        <span class="highlight">FlowPay</span>
                        <br>مستقبل التحويلات المالية
                    </h1>
                    <p class="hero-description">
                        التطبيق الأول في المنطقة للتحويلات المالية السريعة والآمنة. حوّل أموالك، اشترِ بالفيزا الوهمية، وأرسل الأموال لأصدقائك بضغطة واحدة.
                    </p>
    ...
    <section id="about" class="about">
        <div class="container">
            <div class="section-header">
                ...
                <p class="section-subtitle">تطبيق FlowPay يوفر لك حلول مالية متكاملة وآمنة</p>
            </div>
    ...
    <section id="features" class="features">
        <div class="container">
            <div class="section-header">
                ...
                <p class="section-subtitle">اكتشف الميزات الرائعة التي تجعل تجربتك المالية أسهل وأكثر أمانًا</p>
            </div>
            ...
            <div class="faq-container">
                <div class="faq-item">
                    <div class="faq-question">
                        <h3>كيف يمكنني تحميل التطبيق؟</h3>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                    <div class="faq-answer">
                        <p>يمكنك تحميل التطبيق من متجر Google Play أو App Store مجانًا. ابحث عن "FlowPay" وحمّل التطبيق واتبع خطوات التسجيل البسيطة.</p>
                    </div>
                </div>
                <div class="faq-item">
                    <div class="faq-question">
                        <h3>هل التطبيق آمن للاستخدام؟</h3>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                    <div class="faq-answer">
                        <p>نعم، التطبيق يستخدم أحدث تقنيات التشفير والحماية لضمان أمان معاملاتك وبياناتك الشخصية. كما أننا مرخصون من قبل البنك المركزي.</p>
                    </div>
                </div>
                <div class="faq-item">
                    <div class="faq-question">
                        <h3>ما هي رسوم التحويل؟</h3>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                    <div class="faq-answer">
                        <p>نقدم أقل الرسوم في السوق. الرسوم تختلف حسب المبلغ والوجهة، ولكنها تبدأ من 1% فقط للتحويلات المحلية و2% للتحويلات الدولية.</p>
                    </div>
                </div>
                <div class="faq-item">
                    <div class="faq-question">
                        <h3>كم يستغرق وقت التحويل؟</h3>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                    <div class="faq-answer">
                        <p>التحويلات المحلية تتم فوريًا، بينما التحويلات الدولية تستغرق من 1-3 أيام عمل حسب البنك المستقبل والدولة.</p>
                    </div>
                </div>
                <div class="faq-item">
                    <div class="faq-question">
                    ...
                    <div class="faq-answer">
                        <p>الفيزا الوهمية هي بطاقة رقمية مؤقتة يمكنك إنشاؤها للتسوق الآمن عبر الإنترنت. تحدد المبلغ والمدة، وتستخدم البطاقة دون الكشف عن بياناتك البنكية الحقيقية.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <footer id="contact" class="footer">
        <div class="container">
            ...
            <div class="footer-bottom">
                <p>&copy; 2024 FlowPay. جميع الحقوق محفوظة</p>
            </div>
        </div>
    </footer>
